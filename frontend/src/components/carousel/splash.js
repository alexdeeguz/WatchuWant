        ...
        return(
            <div className='outter-slide-wrap'>
                <div id='slideshow'>
                    ...
                    <div>
                        <img className="food-slide-pic" src="https://images.unsplash.com/photo-1504674900247-0877df9cc836?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80" alt='food-6'></img>
                    </div>
                </div>
            </div>
        )
